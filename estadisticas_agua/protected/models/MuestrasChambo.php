...
/**
 * This is the model class for table "muestras_chambo".
 *
 * The followings are the available columns in table 'muestras_chambo':
 ...
 */
class MuestrasChambo extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasChambo the static model class
	 */
