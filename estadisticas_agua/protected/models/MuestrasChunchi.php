...
/**
 * This is the model class for table "muestras_chunchi".
 *
 * The followings are the available columns in table 'muestras_chunchi':
 ...
 */
class MuestrasChunchi extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasChunchi the static model class
	 */
