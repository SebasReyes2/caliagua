...
/**
 * This is the model class for table "muestras_colta".
 *
 * The followings are the available columns in table 'muestras_colta':
 ...
 */
class MuestrasColta extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasColta the static model class
	 */
