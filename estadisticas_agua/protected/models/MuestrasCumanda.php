...
/**
 * This is the model class for table "muestras_cumanda".
 *
 * The followings are the available columns in table 'muestras_cumanda':
 ...
 */
class MuestrasCumanda extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasCumanda the static model class
	 */
