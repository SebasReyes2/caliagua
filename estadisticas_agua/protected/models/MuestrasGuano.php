...
/**
 * This is the model class for table "muestras_guano".
 *
 * The followings are the available columns in table 'muestras_guano':
 ...
 */
class MuestrasGuano extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasGuano the static model class
	 */
