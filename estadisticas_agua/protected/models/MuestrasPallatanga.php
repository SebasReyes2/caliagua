...
/**
 * This is the model class for table "muestras_pallatanga".
 *
 * The followings are the available columns in table 'muestras_pallatanga':
 ...
 */
class MuestrasPallatanga extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasPallatanga the static model class
	 */
