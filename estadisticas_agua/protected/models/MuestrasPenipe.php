...
/**
 * This is the model class for table "muestras_penipe".
 *
 * The followings are the available columns in table 'muestras_penipe':
 ...
 */
class MuestrasPenipe extends CActiveRecord
{
	/**
	 ...
	 * @return MuestrasPenipe the static model class
	 */
