...
$this->pageTitle=Yii::app()->name . ' - Calidad del agua de Alausí';
$this->breadcrumbs=array(
	'Calidad del agua del cantón Alausí',
);
?>
<h3>Calidad del agua del cantón Alausi</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $datos = numreg_muestras_alausi($id2);
                    if($datos>0){
                        $regis = getCalidadAlausi($id2);
                        if(count($regis)==1){
...
<?php $this->beginWidget('application.extensions.jui.ETab',array('name'=>'tab1','title'=>'Gráfica')) ?>
    ...
    'options' => array(
      ...
      'title' => array('text' => "Calidad del agua del cantón Alausí"),
