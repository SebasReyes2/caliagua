...
$this->pageTitle=Yii::app()->name . ' - Calidad del agua de Chambo';
$this->breadcrumbs=array(
	'Calidad del agua del cantón Chambo',
);
?>
<h3>Calidad del agua del cantón Chambo</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $datos = numreg_muestras_chambo($id2);
                    if($datos>0){
                        $regis = getCalidadChambo($id2);
                        if(count($regis)==1){
...
<?php $this->beginWidget('application.extensions.jui.ETab',array('name'=>'tab1','title'=>'Gráfica')) ?>
    ...
    'options' => array(
      ...
      'title' => array('text' => "Calidad del agua del cantón Chambo"),
