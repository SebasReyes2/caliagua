...
$this->pageTitle=Yii::app()->name . ' - Calidad agua Colta';
$this->breadcrumbs=array('Calidad del agua del cantón Colta',
);
?>
<h3>Calidad del agua del cantón Colta</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $datos = numreg_muestras_colta($id2);
                    if($datos>0){
                        $regis = getCalidadColta($id2);
                        if(count($regis)==1){
...
<?php $this->beginWidget('application.extensions.jui.ETab',array('name'=>'tab1','title'=>'Gráfica')) ?>
    ...
    'options' => array(
      ...
      'title' => array('text' => "Calidad del agua del cantón Colta"),
