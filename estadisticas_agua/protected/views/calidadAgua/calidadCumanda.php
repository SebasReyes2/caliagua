...
$this->pageTitle=Yii::app()->name . ' - Calidad agua Cumandá';
$this->breadcrumbs=array('Calidad del agua del cantón Cumandá',
);
?>
<h3>Calidad del agua del cantón Cumandá</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $datos = numreg_muestras_cumanda($id2);
                    if($datos>0){
                        $regis = getCalidadCumanda($id2);
                        if(count($regis)==1){
...
<?php $this->beginWidget('application.extensions.jui.ETab',array('name'=>'tab1','title'=>'Gráfica')) ?>
    ...
    'options' => array(
      ...
      'title' => array('text' => "Calidad del agua del cantón Cumandá"),
