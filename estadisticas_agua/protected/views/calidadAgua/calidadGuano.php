...
$this->pageTitle=Yii::app()->name . ' - Calidad agua Guano';
$this->breadcrumbs=array('Calidad del agua del cantón Guano',
);
?>
<h3>Calidad del agua del cantón Guano</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $datos = numreg_muestras_guano($id2);
                    if($datos>0){
                        $regis = getCalidadGuano($id2);
                        if(count($regis)==1){
...
<?php $this->beginWidget('application.extensions.jui.ETab',array('name'=>'tab1','title'=>'Gráfica')) ?>
    ...
    'options' => array(
      ...
      'title' => array('text' => "Calidad del agua del cantón Guano"),
