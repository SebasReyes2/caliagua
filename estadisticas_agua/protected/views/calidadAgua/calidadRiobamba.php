...
$this->pageTitle=Yii::app()->name . ' - Calidad del agua de Riobamba';
$this->breadcrumbs=array(
	'Calidad del agua del cantón Riobamba',
);
?>
<h3>Calidad del agua del cantón Riobamba</h3>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    $datos = getreg_sistema($id2);
                    if($datos>0){
                        $regis = getCalidadRiobamba($id2);
                        if(count($regis)==1){
...
<?php $this->beginWidget('application.extensions.jui.ETab',array('name'=>'tab1','title'=>'Gráfica')) ?>
    ...
    'options' => array(
      ...
      'title' => array('text' => "Calidad del agua del cantón Riobamba"),
