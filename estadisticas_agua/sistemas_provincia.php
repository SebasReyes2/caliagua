...
require_once 'funciones/nombres_provincia.php';
function bombeo_canton($id_provincia){
    ...
    $sql = "select codsistema
            ...
            on cantones.codcanton=provincias.cod_provincia
...
function gravedad_canton($id_provincia){
    require_once '../conexion/Conexion.php';
    unset($sql);
    $sql = "select codsistema
            from sistemas
...
<body>
    ...
    <div class="container text-center">
        <div class="alert alert-error">
            <h2>NO EXISTEN DATOS DEL CANTÓN <?php echo $nombrecanton ?></h2>
        </div>
    </div>
    <?php
    }
