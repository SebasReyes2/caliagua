...
<body>
<form id="datostecnicos" name="datostecnicos" method="post" action="resultados.php">
<fieldset><legend>Parametros de búsqueda de fichas</legend>
  ...
  <label>Barrio <strong class="p_form">(*)</strong>:</label>
